...
export default function Search({className, onChange, placeholder, value}: Props) {
    return <div className={`${className} grow flex gap-1.5 items-center h-10 px-3 py-2 border border-neutral-300 rounded-full md:h-11 md:px-4`}>
        ...
        <Input className="grow p-0 border-0 shadow-none" type="text" value={value} placeholder={placeholder} onChange={onChange} aria-label="Search"/>
    </div>;
}
